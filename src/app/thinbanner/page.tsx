  ...
  return (
    <tr className="group hover:bg-gray-50/50 transition-colors">
      ...
      <td className="pl-3 pr-2 py-2">
        <button
          onClick={onViewImage}
          className="relative w-24 h-8 rounded overflow-hidden bg-gray-100 group/img block flex-shrink-0"
        >
  ...
  const uploadBanner = async (file: File) => {
    try {
      ...
      const storageRef = ref(
        storage,
        `market_thin_banners/${timestamp}_${file.name}`
      );
          ...
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
            <div className="flex items-center justify-between h-14">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center justify-center w-7 h-7 bg-orange-600 rounded-md">
              ...
              <button
                ...
                disabled={uploading}
                className="flex items-center gap-1.5 px-3 py-1.5 bg-orange-600 hover:bg-orange-700 text-white rounded-md text-xs font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <main className="max-w-[1400px] mx-auto px-4 sm:px-6 py-4 space-y-4">
          ...
          <div className="grid grid-cols-4 gap-3">
            {[
              ...
              { label: "Manuel", value: statsManual, color: "text-orange-600", bg: "bg-orange-50", icon: <Maximize2 className="w-3.5 h-3.5" /> },
          ...
          >
            ...
            <p className="text-xs text-gray-500">
              ...
              <span className="text-gray-400 ml-1">(PNG, JPG — ince banner formatı)</span>
            </p>
            <input
              ref={fileInputRef}
              type="file"
